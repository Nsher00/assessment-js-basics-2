...
//CODE HERE
const empOne = new Employee('Jess','weekday mornings, weekend afternoons')
...
//CODE HERE
let employees = ['Cece','Schmit']
const manager = new Manager('Winston', 'weekday morning, weekday afternoons',employees)
